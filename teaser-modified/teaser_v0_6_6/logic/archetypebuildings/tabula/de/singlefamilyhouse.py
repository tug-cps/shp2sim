...
from teaser_v0_6_6.logic.archetypebuildings.residential \
    import Residential
...
from teaser_v0_6_6.logic.buildingobjects.buildingphysics.groundfloor \
    import GroundFloor
...
class SingleFamilyHouse(Residential):
    ...
    elements XML ('teaser_v0_6_6.data.input.inputdata.TypeElements_TABULA_DE.xml'). The
