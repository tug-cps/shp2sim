...
import os
import sys
import teaser_v0_6_6.logic.utilities as utils
...
class DataClass(object):
    ...
    path_tb : str
        ...
        teaser_v0_6_6/data/input/inputdata/TypeBuildingElements.xml
    ...
    path_mat : str
        ...
        with XSD schema). Default is
        teaser_v0_6_6/data/input/inputdata/MaterialTemplates.xml
    ...
    path_uc : str
        ...
        with XSD schema). Default is
        teaser_v0_6_6/data/input/inputdata/UseConditions.xml
    """
    ...
    def load_tb_binding(self):
        ...
        if version_parse is False:
            import teaser_v0_6_6.data.bindings.v_0_6.typeelement_bind as tb_bind
            ...
            warnings.warn(
                ...
                "base XML file")
            import teaser_v0_6_6.data.bindings.v_0_3_9.typeelement_bind as tb_bind
            ...
            warnings.warn(
                "You are using an old version of type building element data "
                "base XML file")
            import teaser_v0_6_6.data.bindings.v_0_4.typeelement_bind as tb_bind
            self.element_bind = tb_bind.CreateFromDocument(
                __xml_file_tb.read())
    ...
    def load_uc_binding(self):
        ...
        if version_parse is False:
            import teaser_v0_6_6.data.bindings.v_0_6.boundaryconditions_bind as uc_bind
            self.conditions_bind = uc_bind.UseConditions()
        elif bool(version_parse.getroot().attrib) is False:
            warnings.warn("You are using an old version of use condition data "
                          "base XML file")
            import teaser_v0_6_6.data.bindings.v_0_3_9.boundaryconditions_bind as uc_bind
            ...
            warnings.warn("You are using an old version of use condition data "
                          "base XML file")
            import teaser_v0_6_6.data.bindings.v_0_4.boundaryconditions_bind as uc_bind
            self.conditions_bind = uc_bind.CreateFromDocument(
                __xml_file_uc.read())
        elif version_parse.getroot().attrib['version'] == "0.6":
            import teaser_v0_6_6.data.bindings.v_0_6.boundaryconditions_bind as uc_bind
    ...
    def load_mat_binding(self):
        ...
        if version_parse is False:
            import teaser_v0_6_6.data.bindings.v_0_6.material_bind as mat_bind
            self.material_bind = mat_bind.MaterialTemplates()
        elif bool(version_parse.getroot().attrib) is False:
            warnings.warn(
                "You are using an old version of material data base XML file")
            import teaser_v0_6_6.data.bindings.v_0_3_9.material_bind as mat_bind
            ...
            warnings.warn(
                "You are using an old version of material data base XML file")
            import teaser_v0_6_6.data.bindings.v_0_4.material_bind as mat_bind
            self.material_bind = mat_bind.CreateFromDocument(
                __xml_file_mat.read())
        elif version_parse.getroot().attrib['version'] == "0.6":
            import teaser_v0_6_6.data.bindings.v_0_6.material_bind as mat_bind
