...
import teaser_v0_6_6.data.bindings.opengis
import teaser_v0_6_6.data.bindings.opengis.citygml.raw.base as citygml
import teaser_v0_6_6.data.bindings.opengis.citygml.raw.energy as energy
import teaser_v0_6_6.data.bindings.opengis.citygml.raw.building as bldg
import teaser_v0_6_6.data.bindings.opengis.citygml.raw.generics as gen
import teaser_v0_6_6.data.bindings.opengis.raw.gml as gml
import teaser_v0_6_6.data.bindings.opengis.raw._nsgroup as nsgroup
import teaser_v0_6_6.data.bindings.opengis.raw.smil20 as smil
import teaser_v0_6_6.data.bindings.opengis.misc.raw.xAL as xal
                ...
                if part.BuildingPart.function:
                    if part.BuildingPart.function[0].value() == "1000":
                        ...
                        bld = Office(
                            parent=prj,
                            name=part.BuildingPart.id)
                    elif part.BuildingPart.function[0].value() == "institute":
                        bld = Institute(
                            parent=prj,
                            name=part.BuildingPart.id)
                    elif part.BuildingPart.function[0].value() == "institute4":
                        bld = Institute4(
                            parent=prj,
                            name=part.BuildingPart.id)

                    elif part.BuildingPart.function[0].value() == "institute8":
                        bld = Institute8(
                            parent=prj,
                            name=part.BuildingPart.id)
                    else:
            ...
            if city_object.Feature.function:
                if city_object.Feature.function[0].value() == "1000":
                    ...
                    bld = Office(
                        parent=prj,
                        name=city_object.Feature.id)
                elif city_object.Feature.function[0].value() == "institute":
                    bld = Institute(
                        parent=prj,
                        name=city_object.Feature.id)
                elif city_object.Feature.function[0].value() == "institute4":
                    bld = Institute4(
                        parent=prj,
                        name=city_object.Feature.id)
                elif city_object.Feature.function[0].value() == "institute8":
                    bld = Institute8(
                        parent=prj,
                        name=city_object.Feature.id)
                else:
