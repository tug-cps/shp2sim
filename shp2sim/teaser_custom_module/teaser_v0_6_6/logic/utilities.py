...
def get_default_path():
    ...
    # teaser_default_path = os.path.join(directory[:last_index], "teaser_v0_6_6",
    # "OutputData")
...
def get_full_path(rel_path):
    """Helperfunction to construct pathes to files within teaser_v0_6_6.

    Parameters
    ----------
    rel_path : str
        Relative path beginning from teaser_v0_6_6 source folder including
        filename
    ...
    src = "teaser_v0_6_6"
    last_index = directory.rfind(src)
    first_path = os.path.join(directory[:last_index], "teaser_v0_6_6")
...
def clear_directory(dir_path=None):
    ...
    ----------
    dir_path : str
        Path of directory to be deleted. By default the teaser_v0_6_6 default
