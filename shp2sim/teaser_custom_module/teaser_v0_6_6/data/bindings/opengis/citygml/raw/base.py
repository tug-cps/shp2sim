...
import teaser_v0_6_6.data.bindings.opengis.misc.raw.xAL
...
_Namespace_xAL = teaser_v0_6_6.data.bindings.opengis.misc.raw.xAL.Namespace
...
# superclasses teaser_v0_6_6.data.bindings.opengis.raw.gml.doubleList
...
class CityModelType (teaser_v0_6_6.data.bindings.opengis.raw.gml.AbstractFeatureCollectionType):
    ...
    _ElementMap = teaser_v0_6_6.data.bindings.opengis.raw.gml.AbstractFeatureCollectionType._ElementMap.copy()
    _AttributeMap = teaser_v0_6_6.data.bindings.opengis.raw.gml.AbstractFeatureCollectionType._AttributeMap.copy()
    # Base type is teaser_v0_6_6.data.bindings.opengis.raw.gml.AbstractFeatureCollectionType
...
class AbstractCityObjectType (teaser_v0_6_6.data.bindings.opengis.raw.gml.AbstractFeatureType):
    ...
    _ElementMap = teaser_v0_6_6.data.bindings.opengis.raw.gml.AbstractFeatureType._ElementMap.copy()
    _AttributeMap = teaser_v0_6_6.data.bindings.opengis.raw.gml.AbstractFeatureType._AttributeMap.copy()
    # Base type is teaser_v0_6_6.data.bindings.opengis.raw.gml.AbstractFeatureType
...
class AddressType (teaser_v0_6_6.data.bindings.opengis.raw.gml.AbstractFeatureType):
...
class ImplicitGeometryType (teaser_v0_6_6.data.bindings.opengis.raw.gml.AbstractGMLType):
    ...
    _ElementMap = teaser_v0_6_6.data.bindings.opengis.raw.gml.AbstractGMLType._ElementMap.copy()
    _AttributeMap = teaser_v0_6_6.data.bindings.opengis.raw.gml.AbstractGMLType._AttributeMap.copy()
    # Base type is teaser_v0_6_6.data.bindings.opengis.raw.gml.AbstractGMLType
...
cityObjectMember = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'cityObjectMember'), teaser_v0_6_6.data.bindings.opengis.raw.gml.FeaturePropertyType, location=pyxb.utils.utility.Location('/home/micha/GIT/pyxb/pyxb/bundles/opengis/schemas/citygml/2.0/cityGMLBase.xsd', 47, 1))
...
AddressType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'multiPoint'), teaser_v0_6_6.data.bindings.opengis.raw.gml.MultiPointPropertyType, scope=AddressType, location=pyxb.utils.utility.Location('/home/micha/GIT/pyxb/pyxb/bundles/opengis/schemas/citygml/2.0/cityGMLBase.xsd', 210, 5)))
...
ImplicitGeometryType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mimeType'), teaser_v0_6_6.data.bindings.opengis.raw.gml.CodeType, scope=ImplicitGeometryType, location=pyxb.utils.utility.Location('/home/micha/GIT/pyxb/pyxb/bundles/opengis/schemas/citygml/2.0/cityGMLBase.xsd', 249, 5)))
...
ImplicitGeometryType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'relativeGMLGeometry'), teaser_v0_6_6.data.bindings.opengis.raw.gml.GeometryPropertyType, scope=ImplicitGeometryType, location=pyxb.utils.utility.Location('/home/micha/GIT/pyxb/pyxb/bundles/opengis/schemas/citygml/2.0/cityGMLBase.xsd', 252, 5)))

ImplicitGeometryType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'referencePoint'), teaser_v0_6_6.data.bindings.opengis.raw.gml.PointPropertyType, scope=ImplicitGeometryType, location=pyxb.utils.utility.Location('/home/micha/GIT/pyxb/pyxb/bundles/opengis/schemas/citygml/2.0/cityGMLBase.xsd', 253, 5)))
...
cityObjectMember._setSubstitutionGroup(teaser_v0_6_6.data.bindings.opengis.raw.gml.featureMember)

CityModel._setSubstitutionGroup(teaser_v0_6_6.data.bindings.opengis.raw.gml.FeatureCollection)

CityObject._setSubstitutionGroup(teaser_v0_6_6.data.bindings.opengis.raw.gml.Feature)

Address._setSubstitutionGroup(teaser_v0_6_6.data.bindings.opengis.raw.gml.Feature)

ImplicitGeometry._setSubstitutionGroup(teaser_v0_6_6.data.bindings.opengis.raw.gml.GML)
