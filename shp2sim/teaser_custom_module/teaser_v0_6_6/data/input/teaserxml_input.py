...
from teaser_v0_6_6.logic.buildingobjects.buildingsystems.buildingahu import\
    BuildingAHU
from teaser_v0_6_6.logic.buildingobjects.boundaryconditions.boundaryconditions \
    import BoundaryConditions
from teaser_v0_6_6.logic.buildingobjects.buildingphysics.outerwall import OuterWall
from teaser_v0_6_6.logic.buildingobjects.buildingphysics.layer import Layer
from teaser_v0_6_6.logic.buildingobjects.buildingphysics.material import Material
from teaser_v0_6_6.logic.buildingobjects.buildingphysics.rooftop import Rooftop
...
from teaser_v0_6_6.logic.buildingobjects.buildingphysics.ceiling import Ceiling
from teaser_v0_6_6.logic.buildingobjects.buildingphysics.floor import Floor
from teaser_v0_6_6.logic.buildingobjects.buildingphysics.window import Window
from teaser_v0_6_6.logic.buildingobjects.buildingphysics.door import Door
...
def load_teaser_xml(path, prj):
    ...
    if bool(version_parse.getroot().attrib) is False:
        ...
        import teaser_v0_6_6.data.bindings.v_0_3_9.project_bind as pb
        ...
        warnings.warn("You are using an old version of project XML file")
        import teaser_v0_6_6.data.bindings.v_0_4.project_bind as pb
        project_bind = pb.CreateFromDocument(xml_file.read())
    elif version_parse.getroot().attrib['version'] == "0.5":
        warnings.warn("You are using an old version of project XML file")
        import teaser_v0_6_6.data.bindings.v_0_5.project_bind as pb
        project_bind = pb.CreateFromDocument(xml_file.read())
    elif version_parse.getroot().attrib['version'] == "0.6":
        import teaser_v0_6_6.data.bindings.v_0_6.project_bind as pb
        project_bind = pb.CreateFromDocument(xml_file.read())
...
def set_basic_data_teaser(pyxb_class, element):
    ...
    element : TEASERClass
        teaser_v0_6_6 class representation of a building element
