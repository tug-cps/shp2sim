...
within Inffeldgasse.Inffeldgasse25E_4;
model Inffeldgasse25E_4
  "This is the simulation model of Inffeldgasse25E_4 with traceable ID 61"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 5008.182292543353,
    ABuilding=367.267822265625,
    ASurTot=18364.451325590322,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25E_4_DataBase.Inffeldgasse25E_4_Office(),
      Inffeldgasse25E_4_DataBase.Inffeldgasse25E_4_Floor(),
      Inffeldgasse25E_4_DataBase.Inffeldgasse25E_4_Storage(),
      Inffeldgasse25E_4_DataBase.Inffeldgasse25E_4_Meeting(),
      Inffeldgasse25E_4_DataBase.Inffeldgasse25E_4_Restroom(),
      Inffeldgasse25E_4_DataBase.Inffeldgasse25E_4_ICT(),
      Inffeldgasse25E_4_DataBase.Inffeldgasse25E_4_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25E_4/InternalGains_Inffeldgasse25E_4.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25E_4/AHU_Inffeldgasse25E_4.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25E_4/Tset_Inffeldgasse25E_4.mat"),
    columns=2:8)
