...
within Inffeldgasse.Inffeldgasse18_9;
model Inffeldgasse18_9
  "This is the simulation model of Inffeldgasse18_9 with traceable ID 19"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 2958.8056927248836,
    ABuilding=442.52001953125,
    ASurTot=11251.217571127343,
    numZones = 7,
    zoneParam = {
      Inffeldgasse18_9_DataBase.Inffeldgasse18_9_Office(),
      Inffeldgasse18_9_DataBase.Inffeldgasse18_9_Floor(),
      Inffeldgasse18_9_DataBase.Inffeldgasse18_9_Storage(),
      Inffeldgasse18_9_DataBase.Inffeldgasse18_9_Meeting(),
      Inffeldgasse18_9_DataBase.Inffeldgasse18_9_Restroom(),
      Inffeldgasse18_9_DataBase.Inffeldgasse18_9_ICT(),
      Inffeldgasse18_9_DataBase.Inffeldgasse18_9_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse18_9/InternalGains_Inffeldgasse18_9.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse18_9/AHU_Inffeldgasse18_9.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse18_9/Tset_Inffeldgasse18_9.mat"),
    columns=2:8)
