...
within Inffeldgasse.Inffeldgasse25C_7;
model Inffeldgasse25C_7
  "This is the simulation model of Inffeldgasse25C_7 with traceable ID 80"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 2891.0571411252026,
    ABuilding=760.53515625,
    ASurTot=14605.152639095895,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25C_7_DataBase.Inffeldgasse25C_7_Office(),
      Inffeldgasse25C_7_DataBase.Inffeldgasse25C_7_Floor(),
      Inffeldgasse25C_7_DataBase.Inffeldgasse25C_7_Storage(),
      Inffeldgasse25C_7_DataBase.Inffeldgasse25C_7_Meeting(),
      Inffeldgasse25C_7_DataBase.Inffeldgasse25C_7_Restroom(),
      Inffeldgasse25C_7_DataBase.Inffeldgasse25C_7_ICT(),
      Inffeldgasse25C_7_DataBase.Inffeldgasse25C_7_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25C_7/InternalGains_Inffeldgasse25C_7.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25C_7/AHU_Inffeldgasse25C_7.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25C_7/Tset_Inffeldgasse25C_7.mat"),
    columns=2:8)
