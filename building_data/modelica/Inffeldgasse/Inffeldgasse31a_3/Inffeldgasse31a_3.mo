...
within Inffeldgasse.Inffeldgasse31a_3;
model Inffeldgasse31a_3
  "This is the simulation model of Inffeldgasse31a_3 with traceable ID 23"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 128.12927213311195,
    ABuilding=41.067138671875,
    ASurTot=586.2520432208992,
    numZones = 7,
    zoneParam = {
      Inffeldgasse31a_3_DataBase.Inffeldgasse31a_3_Office(),
      Inffeldgasse31a_3_DataBase.Inffeldgasse31a_3_Floor(),
      Inffeldgasse31a_3_DataBase.Inffeldgasse31a_3_Storage(),
      Inffeldgasse31a_3_DataBase.Inffeldgasse31a_3_Meeting(),
      Inffeldgasse31a_3_DataBase.Inffeldgasse31a_3_Restroom(),
      Inffeldgasse31a_3_DataBase.Inffeldgasse31a_3_ICT(),
      Inffeldgasse31a_3_DataBase.Inffeldgasse31a_3_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse31a_3/InternalGains_Inffeldgasse31a_3.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse31a_3/AHU_Inffeldgasse31a_3.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse31a_3/Tset_Inffeldgasse31a_3.mat"),
    columns=2:8)
