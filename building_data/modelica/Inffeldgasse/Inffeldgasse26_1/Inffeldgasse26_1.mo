...
within Inffeldgasse.Inffeldgasse26_1;
model Inffeldgasse26_1
  "This is the simulation model of Inffeldgasse26_1 with traceable ID 0"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 20552.251630559564,
    ABuilding=2768.986083984375,
    ASurTot=75400.02749089657,
    numZones = 7,
    zoneParam = {
      Inffeldgasse26_1_DataBase.Inffeldgasse26_1_Office(),
      Inffeldgasse26_1_DataBase.Inffeldgasse26_1_Floor(),
      Inffeldgasse26_1_DataBase.Inffeldgasse26_1_Storage(),
      Inffeldgasse26_1_DataBase.Inffeldgasse26_1_Meeting(),
      Inffeldgasse26_1_DataBase.Inffeldgasse26_1_Restroom(),
      Inffeldgasse26_1_DataBase.Inffeldgasse26_1_ICT(),
      Inffeldgasse26_1_DataBase.Inffeldgasse26_1_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse26_1/InternalGains_Inffeldgasse26_1.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse26_1/AHU_Inffeldgasse26_1.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse26_1/Tset_Inffeldgasse26_1.mat"),
    columns=2:8)
