...
within Inffeldgasse.Inffeldgasse25F_4;
model Inffeldgasse25F_4
  "This is the simulation model of Inffeldgasse25F_4 with traceable ID 49"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 2482.603546112776,
    ABuilding=645.39892578125,
    ASurTot=12435.601106576629,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25F_4_DataBase.Inffeldgasse25F_4_Office(),
      Inffeldgasse25F_4_DataBase.Inffeldgasse25F_4_Floor(),
      Inffeldgasse25F_4_DataBase.Inffeldgasse25F_4_Storage(),
      Inffeldgasse25F_4_DataBase.Inffeldgasse25F_4_Meeting(),
      Inffeldgasse25F_4_DataBase.Inffeldgasse25F_4_Restroom(),
      Inffeldgasse25F_4_DataBase.Inffeldgasse25F_4_ICT(),
      Inffeldgasse25F_4_DataBase.Inffeldgasse25F_4_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25F_4/InternalGains_Inffeldgasse25F_4.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25F_4/AHU_Inffeldgasse25F_4.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25F_4/Tset_Inffeldgasse25F_4.mat"),
    columns=2:8)
