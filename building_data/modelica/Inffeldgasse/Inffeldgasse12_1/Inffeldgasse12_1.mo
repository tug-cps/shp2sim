...
within Inffeldgasse.Inffeldgasse12_1;
model Inffeldgasse12_1
  "This is the simulation model of Inffeldgasse12_1 with traceable ID 9"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 2439.2302839159966,
    ABuilding=505.970703125,
    ASurTot=14985.01665599379,
    numZones = 7,
    zoneParam = {
      Inffeldgasse12_1_DataBase.Inffeldgasse12_1_Office(),
      Inffeldgasse12_1_DataBase.Inffeldgasse12_1_Floor(),
      Inffeldgasse12_1_DataBase.Inffeldgasse12_1_Storage(),
      Inffeldgasse12_1_DataBase.Inffeldgasse12_1_Meeting(),
      Inffeldgasse12_1_DataBase.Inffeldgasse12_1_Restroom(),
      Inffeldgasse12_1_DataBase.Inffeldgasse12_1_ICT(),
      Inffeldgasse12_1_DataBase.Inffeldgasse12_1_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse12_1/InternalGains_Inffeldgasse12_1.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse12_1/AHU_Inffeldgasse12_1.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse12_1/Tset_Inffeldgasse12_1.mat"),
    columns=2:8)
