...
within Inffeldgasse.Inffeldgasse25D_4;
model Inffeldgasse25D_4
  "This is the simulation model of Inffeldgasse25D_4 with traceable ID 69"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 898.3722728490832,
    ABuilding=199.6484375,
    ASurTot=4473.184838958905,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25D_4_DataBase.Inffeldgasse25D_4_Office(),
      Inffeldgasse25D_4_DataBase.Inffeldgasse25D_4_Floor(),
      Inffeldgasse25D_4_DataBase.Inffeldgasse25D_4_Storage(),
      Inffeldgasse25D_4_DataBase.Inffeldgasse25D_4_Meeting(),
      Inffeldgasse25D_4_DataBase.Inffeldgasse25D_4_Restroom(),
      Inffeldgasse25D_4_DataBase.Inffeldgasse25D_4_ICT(),
      Inffeldgasse25D_4_DataBase.Inffeldgasse25D_4_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25D_4/InternalGains_Inffeldgasse25D_4.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25D_4/AHU_Inffeldgasse25D_4.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25D_4/Tset_Inffeldgasse25D_4.mat"),
    columns=2:8)
