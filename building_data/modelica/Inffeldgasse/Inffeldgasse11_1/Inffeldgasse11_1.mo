...
within Inffeldgasse.Inffeldgasse11_1;
model Inffeldgasse11_1
  "This is the simulation model of Inffeldgasse11_1 with traceable ID 36"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 6591.309251666069,
    ABuilding=1324.92529296875,
    ASurTot=30448.54548481307,
    numZones = 7,
    zoneParam = {
      Inffeldgasse11_1_DataBase.Inffeldgasse11_1_Office(),
      Inffeldgasse11_1_DataBase.Inffeldgasse11_1_Floor(),
      Inffeldgasse11_1_DataBase.Inffeldgasse11_1_Storage(),
      Inffeldgasse11_1_DataBase.Inffeldgasse11_1_Meeting(),
      Inffeldgasse11_1_DataBase.Inffeldgasse11_1_Restroom(),
      Inffeldgasse11_1_DataBase.Inffeldgasse11_1_ICT(),
      Inffeldgasse11_1_DataBase.Inffeldgasse11_1_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse11_1/InternalGains_Inffeldgasse11_1.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse11_1/AHU_Inffeldgasse11_1.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse11_1/Tset_Inffeldgasse11_1.mat"),
    columns=2:8)
