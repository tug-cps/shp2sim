...
within Inffeldgasse.Inffeldgasse25F_3;
model Inffeldgasse25F_3
  "This is the simulation model of Inffeldgasse25F_3 with traceable ID 48"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 2306.3077236115932,
    ABuilding=546.97314453125,
    ASurTot=11288.03366470373,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25F_3_DataBase.Inffeldgasse25F_3_Office(),
      Inffeldgasse25F_3_DataBase.Inffeldgasse25F_3_Floor(),
      Inffeldgasse25F_3_DataBase.Inffeldgasse25F_3_Storage(),
      Inffeldgasse25F_3_DataBase.Inffeldgasse25F_3_Meeting(),
      Inffeldgasse25F_3_DataBase.Inffeldgasse25F_3_Restroom(),
      Inffeldgasse25F_3_DataBase.Inffeldgasse25F_3_ICT(),
      Inffeldgasse25F_3_DataBase.Inffeldgasse25F_3_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25F_3/InternalGains_Inffeldgasse25F_3.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25F_3/AHU_Inffeldgasse25F_3.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25F_3/Tset_Inffeldgasse25F_3.mat"),
    columns=2:8)
