...
within Inffeldgasse.Inffeldgasse24_4;
model Inffeldgasse24_4
  "This is the simulation model of Inffeldgasse24_4 with traceable ID 4"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 7990.894050195814,
    ABuilding=2752.31982421875,
    ASurTot=47084.6033980169,
    numZones = 7,
    zoneParam = {
      Inffeldgasse24_4_DataBase.Inffeldgasse24_4_Office(),
      Inffeldgasse24_4_DataBase.Inffeldgasse24_4_Floor(),
      Inffeldgasse24_4_DataBase.Inffeldgasse24_4_Storage(),
      Inffeldgasse24_4_DataBase.Inffeldgasse24_4_Meeting(),
      Inffeldgasse24_4_DataBase.Inffeldgasse24_4_Restroom(),
      Inffeldgasse24_4_DataBase.Inffeldgasse24_4_ICT(),
      Inffeldgasse24_4_DataBase.Inffeldgasse24_4_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse24_4/InternalGains_Inffeldgasse24_4.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse24_4/AHU_Inffeldgasse24_4.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse24_4/Tset_Inffeldgasse24_4.mat"),
    columns=2:8)
