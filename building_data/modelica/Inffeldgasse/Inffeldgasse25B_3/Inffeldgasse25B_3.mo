...
within Inffeldgasse.Inffeldgasse25B_3;
model Inffeldgasse25B_3
  "This is the simulation model of Inffeldgasse25B_3 with traceable ID 84"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 3526.4159173667426,
    ABuilding=671.9130859375,
    ASurTot=16256.787848561444,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25B_3_DataBase.Inffeldgasse25B_3_Office(),
      Inffeldgasse25B_3_DataBase.Inffeldgasse25B_3_Floor(),
      Inffeldgasse25B_3_DataBase.Inffeldgasse25B_3_Storage(),
      Inffeldgasse25B_3_DataBase.Inffeldgasse25B_3_Meeting(),
      Inffeldgasse25B_3_DataBase.Inffeldgasse25B_3_Restroom(),
      Inffeldgasse25B_3_DataBase.Inffeldgasse25B_3_ICT(),
      Inffeldgasse25B_3_DataBase.Inffeldgasse25B_3_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25B_3/InternalGains_Inffeldgasse25B_3.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25B_3/AHU_Inffeldgasse25B_3.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25B_3/Tset_Inffeldgasse25B_3.mat"),
    columns=2:8)
