...
within Inffeldgasse.Inffeldgasse25B_9;
model Inffeldgasse25B_9
  "This is the simulation model of Inffeldgasse25B_9 with traceable ID 90"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 2065.3091708123684,
    ABuilding=338.41748046875,
    ASurTot=8059.759014562946,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25B_9_DataBase.Inffeldgasse25B_9_Office(),
      Inffeldgasse25B_9_DataBase.Inffeldgasse25B_9_Floor(),
      Inffeldgasse25B_9_DataBase.Inffeldgasse25B_9_Storage(),
      Inffeldgasse25B_9_DataBase.Inffeldgasse25B_9_Meeting(),
      Inffeldgasse25B_9_DataBase.Inffeldgasse25B_9_Restroom(),
      Inffeldgasse25B_9_DataBase.Inffeldgasse25B_9_ICT(),
      Inffeldgasse25B_9_DataBase.Inffeldgasse25B_9_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25B_9/InternalGains_Inffeldgasse25B_9.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25B_9/AHU_Inffeldgasse25B_9.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25B_9/Tset_Inffeldgasse25B_9.mat"),
    columns=2:8)
