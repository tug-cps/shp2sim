...
within Inffeldgasse.Inffeldgasse25E_6;
model Inffeldgasse25E_6
  "This is the simulation model of Inffeldgasse25E_6 with traceable ID 63"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 202.45169171690947,
    ABuilding=44.0263671875,
    ASurTot=915.2285015764107,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25E_6_DataBase.Inffeldgasse25E_6_Office(),
      Inffeldgasse25E_6_DataBase.Inffeldgasse25E_6_Floor(),
      Inffeldgasse25E_6_DataBase.Inffeldgasse25E_6_Storage(),
      Inffeldgasse25E_6_DataBase.Inffeldgasse25E_6_Meeting(),
      Inffeldgasse25E_6_DataBase.Inffeldgasse25E_6_Restroom(),
      Inffeldgasse25E_6_DataBase.Inffeldgasse25E_6_ICT(),
      Inffeldgasse25E_6_DataBase.Inffeldgasse25E_6_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25E_6/InternalGains_Inffeldgasse25E_6.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25E_6/AHU_Inffeldgasse25E_6.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25E_6/Tset_Inffeldgasse25E_6.mat"),
    columns=2:8)
