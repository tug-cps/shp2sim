...
within Inffeldgasse.Inffeldgasse25F_7;
model Inffeldgasse25F_7
  "This is the simulation model of Inffeldgasse25F_7 with traceable ID 52"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 5592.062150493264,
    ABuilding=781.1220703124999,
    ASurTot=20896.30604406468,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25F_7_DataBase.Inffeldgasse25F_7_Office(),
      Inffeldgasse25F_7_DataBase.Inffeldgasse25F_7_Floor(),
      Inffeldgasse25F_7_DataBase.Inffeldgasse25F_7_Storage(),
      Inffeldgasse25F_7_DataBase.Inffeldgasse25F_7_Meeting(),
      Inffeldgasse25F_7_DataBase.Inffeldgasse25F_7_Restroom(),
      Inffeldgasse25F_7_DataBase.Inffeldgasse25F_7_ICT(),
      Inffeldgasse25F_7_DataBase.Inffeldgasse25F_7_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25F_7/InternalGains_Inffeldgasse25F_7.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25F_7/AHU_Inffeldgasse25F_7.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25F_7/Tset_Inffeldgasse25F_7.mat"),
    columns=2:8)
