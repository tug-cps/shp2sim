...
within Inffeldgasse.Inffeldgasse18_8;
model Inffeldgasse18_8
  "This is the simulation model of Inffeldgasse18_8 with traceable ID 18"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 5814.82788553834,
    ABuilding=1036.513916015625,
    ASurTot=21199.577101934956,
    numZones = 7,
    zoneParam = {
      Inffeldgasse18_8_DataBase.Inffeldgasse18_8_Office(),
      Inffeldgasse18_8_DataBase.Inffeldgasse18_8_Floor(),
      Inffeldgasse18_8_DataBase.Inffeldgasse18_8_Storage(),
      Inffeldgasse18_8_DataBase.Inffeldgasse18_8_Meeting(),
      Inffeldgasse18_8_DataBase.Inffeldgasse18_8_Restroom(),
      Inffeldgasse18_8_DataBase.Inffeldgasse18_8_ICT(),
      Inffeldgasse18_8_DataBase.Inffeldgasse18_8_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse18_8/InternalGains_Inffeldgasse18_8.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse18_8/AHU_Inffeldgasse18_8.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse18_8/Tset_Inffeldgasse18_8.mat"),
    columns=2:8)
