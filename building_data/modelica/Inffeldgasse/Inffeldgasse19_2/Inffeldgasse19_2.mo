...
within Inffeldgasse.Inffeldgasse19_2;
model Inffeldgasse19_2
  "This is the simulation model of Inffeldgasse19_2 with traceable ID 45"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 687.8972810655833,
    ABuilding=168.10791015625,
    ASurTot=4091.1650893354035,
    numZones = 7,
    zoneParam = {
      Inffeldgasse19_2_DataBase.Inffeldgasse19_2_Office(),
      Inffeldgasse19_2_DataBase.Inffeldgasse19_2_Floor(),
      Inffeldgasse19_2_DataBase.Inffeldgasse19_2_Storage(),
      Inffeldgasse19_2_DataBase.Inffeldgasse19_2_Meeting(),
      Inffeldgasse19_2_DataBase.Inffeldgasse19_2_Restroom(),
      Inffeldgasse19_2_DataBase.Inffeldgasse19_2_ICT(),
      Inffeldgasse19_2_DataBase.Inffeldgasse19_2_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse19_2/InternalGains_Inffeldgasse19_2.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse19_2/AHU_Inffeldgasse19_2.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse19_2/Tset_Inffeldgasse19_2.mat"),
    columns=2:8)
