...
within Inffeldgasse.Inffeldgasse18_1;
model Inffeldgasse18_1
  "This is the simulation model of Inffeldgasse18_1 with traceable ID 20"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 24040.040940910578,
    ABuilding=974.0302734375,
    ASurTot=84552.39702846961,
    numZones = 7,
    zoneParam = {
      Inffeldgasse18_1_DataBase.Inffeldgasse18_1_Office(),
      Inffeldgasse18_1_DataBase.Inffeldgasse18_1_Floor(),
      Inffeldgasse18_1_DataBase.Inffeldgasse18_1_Storage(),
      Inffeldgasse18_1_DataBase.Inffeldgasse18_1_Meeting(),
      Inffeldgasse18_1_DataBase.Inffeldgasse18_1_Restroom(),
      Inffeldgasse18_1_DataBase.Inffeldgasse18_1_ICT(),
      Inffeldgasse18_1_DataBase.Inffeldgasse18_1_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse18_1/InternalGains_Inffeldgasse18_1.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse18_1/AHU_Inffeldgasse18_1.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse18_1/Tset_Inffeldgasse18_1.mat"),
    columns=2:8)
