...
within Inffeldgasse.Inffeldgasse25C_4;
model Inffeldgasse25C_4
  "This is the simulation model of Inffeldgasse25C_4 with traceable ID 77"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 392.2569727376104,
    ABuilding=49.21337890625,
    ASurTot=1684.4880812343013,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25C_4_DataBase.Inffeldgasse25C_4_Office(),
      Inffeldgasse25C_4_DataBase.Inffeldgasse25C_4_Floor(),
      Inffeldgasse25C_4_DataBase.Inffeldgasse25C_4_Storage(),
      Inffeldgasse25C_4_DataBase.Inffeldgasse25C_4_Meeting(),
      Inffeldgasse25C_4_DataBase.Inffeldgasse25C_4_Restroom(),
      Inffeldgasse25C_4_DataBase.Inffeldgasse25C_4_ICT(),
      Inffeldgasse25C_4_DataBase.Inffeldgasse25C_4_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25C_4/InternalGains_Inffeldgasse25C_4.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25C_4/AHU_Inffeldgasse25C_4.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25C_4/Tset_Inffeldgasse25C_4.mat"),
    columns=2:8)
