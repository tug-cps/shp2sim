...
within Inffeldgasse.Inffeldgasse25E_3;
model Inffeldgasse25E_3
  "This is the simulation model of Inffeldgasse25E_3 with traceable ID 60"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 2338.936528533697,
    ABuilding=398.45629882812494,
    ASurTot=9105.897155129274,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25E_3_DataBase.Inffeldgasse25E_3_Office(),
      Inffeldgasse25E_3_DataBase.Inffeldgasse25E_3_Floor(),
      Inffeldgasse25E_3_DataBase.Inffeldgasse25E_3_Storage(),
      Inffeldgasse25E_3_DataBase.Inffeldgasse25E_3_Meeting(),
      Inffeldgasse25E_3_DataBase.Inffeldgasse25E_3_Restroom(),
      Inffeldgasse25E_3_DataBase.Inffeldgasse25E_3_ICT(),
      Inffeldgasse25E_3_DataBase.Inffeldgasse25E_3_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25E_3/InternalGains_Inffeldgasse25E_3.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25E_3/AHU_Inffeldgasse25E_3.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25E_3/Tset_Inffeldgasse25E_3.mat"),
    columns=2:8)
