...
within Inffeldgasse.Inffeldgasse25E_5;
model Inffeldgasse25E_5
  "This is the simulation model of Inffeldgasse25E_5 with traceable ID 62"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 466.3192228041589,
    ABuilding=74.101806640625,
    ASurTot=2135.7410403136464,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25E_5_DataBase.Inffeldgasse25E_5_Office(),
      Inffeldgasse25E_5_DataBase.Inffeldgasse25E_5_Floor(),
      Inffeldgasse25E_5_DataBase.Inffeldgasse25E_5_Storage(),
      Inffeldgasse25E_5_DataBase.Inffeldgasse25E_5_Meeting(),
      Inffeldgasse25E_5_DataBase.Inffeldgasse25E_5_Restroom(),
      Inffeldgasse25E_5_DataBase.Inffeldgasse25E_5_ICT(),
      Inffeldgasse25E_5_DataBase.Inffeldgasse25E_5_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25E_5/InternalGains_Inffeldgasse25E_5.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25E_5/AHU_Inffeldgasse25E_5.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25E_5/Tset_Inffeldgasse25E_5.mat"),
    columns=2:8)
