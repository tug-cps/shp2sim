...
within Inffeldgasse.Inffeldgasse13_2;
model Inffeldgasse13_2
  "This is the simulation model of Inffeldgasse13_2 with traceable ID 41"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 2587.71576449275,
    ABuilding=591.005859375,
    ASurTot=14825.0752845716,
    numZones = 7,
    zoneParam = {
      Inffeldgasse13_2_DataBase.Inffeldgasse13_2_Office(),
      Inffeldgasse13_2_DataBase.Inffeldgasse13_2_Floor(),
      Inffeldgasse13_2_DataBase.Inffeldgasse13_2_Storage(),
      Inffeldgasse13_2_DataBase.Inffeldgasse13_2_Meeting(),
      Inffeldgasse13_2_DataBase.Inffeldgasse13_2_Restroom(),
      Inffeldgasse13_2_DataBase.Inffeldgasse13_2_ICT(),
      Inffeldgasse13_2_DataBase.Inffeldgasse13_2_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse13_2/InternalGains_Inffeldgasse13_2.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse13_2/AHU_Inffeldgasse13_2.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse13_2/Tset_Inffeldgasse13_2.mat"),
    columns=2:8)
