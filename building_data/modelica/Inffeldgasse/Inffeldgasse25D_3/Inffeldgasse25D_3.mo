...
within Inffeldgasse.Inffeldgasse25D_3;
model Inffeldgasse25D_3
  "This is the simulation model of Inffeldgasse25D_3 with traceable ID 68"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 2136.790044441819,
    ABuilding=461.53662109374994,
    ASurTot=10252.94557492474,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25D_3_DataBase.Inffeldgasse25D_3_Office(),
      Inffeldgasse25D_3_DataBase.Inffeldgasse25D_3_Floor(),
      Inffeldgasse25D_3_DataBase.Inffeldgasse25D_3_Storage(),
      Inffeldgasse25D_3_DataBase.Inffeldgasse25D_3_Meeting(),
      Inffeldgasse25D_3_DataBase.Inffeldgasse25D_3_Restroom(),
      Inffeldgasse25D_3_DataBase.Inffeldgasse25D_3_ICT(),
      Inffeldgasse25D_3_DataBase.Inffeldgasse25D_3_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25D_3/InternalGains_Inffeldgasse25D_3.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25D_3/AHU_Inffeldgasse25D_3.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25D_3/Tset_Inffeldgasse25D_3.mat"),
    columns=2:8)
