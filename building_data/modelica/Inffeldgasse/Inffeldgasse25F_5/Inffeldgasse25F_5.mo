...
within Inffeldgasse.Inffeldgasse25F_5;
model Inffeldgasse25F_5
  "This is the simulation model of Inffeldgasse25F_5 with traceable ID 50"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 8132.706971466541,
    ABuilding=1847.8623046874998,
    ASurTot=41074.87885021568,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25F_5_DataBase.Inffeldgasse25F_5_Office(),
      Inffeldgasse25F_5_DataBase.Inffeldgasse25F_5_Floor(),
      Inffeldgasse25F_5_DataBase.Inffeldgasse25F_5_Storage(),
      Inffeldgasse25F_5_DataBase.Inffeldgasse25F_5_Meeting(),
      Inffeldgasse25F_5_DataBase.Inffeldgasse25F_5_Restroom(),
      Inffeldgasse25F_5_DataBase.Inffeldgasse25F_5_ICT(),
      Inffeldgasse25F_5_DataBase.Inffeldgasse25F_5_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25F_5/InternalGains_Inffeldgasse25F_5.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25F_5/AHU_Inffeldgasse25F_5.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25F_5/Tset_Inffeldgasse25F_5.mat"),
    columns=2:8)
