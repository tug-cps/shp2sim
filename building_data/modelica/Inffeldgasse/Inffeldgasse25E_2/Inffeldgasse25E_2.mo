...
within Inffeldgasse.Inffeldgasse25E_2;
model Inffeldgasse25E_2
  "This is the simulation model of Inffeldgasse25E_2 with traceable ID 59"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 6001.640957146883,
    ABuilding=2052.775634765625,
    ASurTot=38825.55058185228,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25E_2_DataBase.Inffeldgasse25E_2_Office(),
      Inffeldgasse25E_2_DataBase.Inffeldgasse25E_2_Floor(),
      Inffeldgasse25E_2_DataBase.Inffeldgasse25E_2_Storage(),
      Inffeldgasse25E_2_DataBase.Inffeldgasse25E_2_Meeting(),
      Inffeldgasse25E_2_DataBase.Inffeldgasse25E_2_Restroom(),
      Inffeldgasse25E_2_DataBase.Inffeldgasse25E_2_ICT(),
      Inffeldgasse25E_2_DataBase.Inffeldgasse25E_2_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25E_2/InternalGains_Inffeldgasse25E_2.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25E_2/AHU_Inffeldgasse25E_2.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25E_2/Tset_Inffeldgasse25E_2.mat"),
    columns=2:8)
