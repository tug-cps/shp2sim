...
within Inffeldgasse.Inffeldgasse24_1;
model Inffeldgasse24_1
  "This is the simulation model of Inffeldgasse24_1 with traceable ID 1"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 24740.464573681355,
    ABuilding=1913.44384765625,
    ASurTot=86461.05032560979,
    numZones = 7,
    zoneParam = {
      Inffeldgasse24_1_DataBase.Inffeldgasse24_1_Office(),
      Inffeldgasse24_1_DataBase.Inffeldgasse24_1_Floor(),
      Inffeldgasse24_1_DataBase.Inffeldgasse24_1_Storage(),
      Inffeldgasse24_1_DataBase.Inffeldgasse24_1_Meeting(),
      Inffeldgasse24_1_DataBase.Inffeldgasse24_1_Restroom(),
      Inffeldgasse24_1_DataBase.Inffeldgasse24_1_ICT(),
      Inffeldgasse24_1_DataBase.Inffeldgasse24_1_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse24_1/InternalGains_Inffeldgasse24_1.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse24_1/AHU_Inffeldgasse24_1.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse24_1/Tset_Inffeldgasse24_1.mat"),
    columns=2:8)
