...
within Inffeldgasse.Inffeldgasse25B_4;
model Inffeldgasse25B_4
  "This is the simulation model of Inffeldgasse25B_4 with traceable ID 85"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 377.07153491675854,
    ABuilding=47.242431640625,
    ASurTot=1628.5153118586659,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25B_4_DataBase.Inffeldgasse25B_4_Office(),
      Inffeldgasse25B_4_DataBase.Inffeldgasse25B_4_Floor(),
      Inffeldgasse25B_4_DataBase.Inffeldgasse25B_4_Storage(),
      Inffeldgasse25B_4_DataBase.Inffeldgasse25B_4_Meeting(),
      Inffeldgasse25B_4_DataBase.Inffeldgasse25B_4_Restroom(),
      Inffeldgasse25B_4_DataBase.Inffeldgasse25B_4_ICT(),
      Inffeldgasse25B_4_DataBase.Inffeldgasse25B_4_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25B_4/InternalGains_Inffeldgasse25B_4.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25B_4/AHU_Inffeldgasse25B_4.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25B_4/Tset_Inffeldgasse25B_4.mat"),
    columns=2:8)
