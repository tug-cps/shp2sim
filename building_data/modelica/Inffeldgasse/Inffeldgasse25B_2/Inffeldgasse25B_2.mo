...
within Inffeldgasse.Inffeldgasse25B_2;
model Inffeldgasse25B_2
  "This is the simulation model of Inffeldgasse25B_2 with traceable ID 83"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 6929.425599977376,
    ABuilding=1978.677490234375,
    ASurTot=41360.59852770246,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25B_2_DataBase.Inffeldgasse25B_2_Office(),
      Inffeldgasse25B_2_DataBase.Inffeldgasse25B_2_Floor(),
      Inffeldgasse25B_2_DataBase.Inffeldgasse25B_2_Storage(),
      Inffeldgasse25B_2_DataBase.Inffeldgasse25B_2_Meeting(),
      Inffeldgasse25B_2_DataBase.Inffeldgasse25B_2_Restroom(),
      Inffeldgasse25B_2_DataBase.Inffeldgasse25B_2_ICT(),
      Inffeldgasse25B_2_DataBase.Inffeldgasse25B_2_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25B_2/InternalGains_Inffeldgasse25B_2.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25B_2/AHU_Inffeldgasse25B_2.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25B_2/Tset_Inffeldgasse25B_2.mat"),
    columns=2:8)
