...
within Inffeldgasse.Inffeldgasse25C_2;
model Inffeldgasse25C_2
  "This is the simulation model of Inffeldgasse25C_2 with traceable ID 75"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 234.02605120092628,
    ABuilding=63.931884765625,
    ASurTot=1060.7723941134113,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25C_2_DataBase.Inffeldgasse25C_2_Office(),
      Inffeldgasse25C_2_DataBase.Inffeldgasse25C_2_Floor(),
      Inffeldgasse25C_2_DataBase.Inffeldgasse25C_2_Storage(),
      Inffeldgasse25C_2_DataBase.Inffeldgasse25C_2_Meeting(),
      Inffeldgasse25C_2_DataBase.Inffeldgasse25C_2_Restroom(),
      Inffeldgasse25C_2_DataBase.Inffeldgasse25C_2_ICT(),
      Inffeldgasse25C_2_DataBase.Inffeldgasse25C_2_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25C_2/InternalGains_Inffeldgasse25C_2.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25C_2/AHU_Inffeldgasse25C_2.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25C_2/Tset_Inffeldgasse25C_2.mat"),
    columns=2:8)
