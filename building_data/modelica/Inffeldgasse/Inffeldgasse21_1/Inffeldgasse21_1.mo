...
within Inffeldgasse.Inffeldgasse21_1;
model Inffeldgasse21_1
  "This is the simulation model of Inffeldgasse21_1 with traceable ID 42"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 20331.025096938014,
    ABuilding=4184.79638671875,
    ASurTot=91417.41675554548,
    numZones = 7,
    zoneParam = {
      Inffeldgasse21_1_DataBase.Inffeldgasse21_1_Office(),
      Inffeldgasse21_1_DataBase.Inffeldgasse21_1_Floor(),
      Inffeldgasse21_1_DataBase.Inffeldgasse21_1_Storage(),
      Inffeldgasse21_1_DataBase.Inffeldgasse21_1_Meeting(),
      Inffeldgasse21_1_DataBase.Inffeldgasse21_1_Restroom(),
      Inffeldgasse21_1_DataBase.Inffeldgasse21_1_ICT(),
      Inffeldgasse21_1_DataBase.Inffeldgasse21_1_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse21_1/InternalGains_Inffeldgasse21_1.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse21_1/AHU_Inffeldgasse21_1.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse21_1/Tset_Inffeldgasse21_1.mat"),
    columns=2:8)
