...
within Inffeldgasse.Inffeldgasse25E_8;
model Inffeldgasse25E_8
  "This is the simulation model of Inffeldgasse25E_8 with traceable ID 65"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 250.5786907672882,
    ABuilding=56.26953125,
    ASurTot=1147.8780619490908,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25E_8_DataBase.Inffeldgasse25E_8_Office(),
      Inffeldgasse25E_8_DataBase.Inffeldgasse25E_8_Floor(),
      Inffeldgasse25E_8_DataBase.Inffeldgasse25E_8_Storage(),
      Inffeldgasse25E_8_DataBase.Inffeldgasse25E_8_Meeting(),
      Inffeldgasse25E_8_DataBase.Inffeldgasse25E_8_Restroom(),
      Inffeldgasse25E_8_DataBase.Inffeldgasse25E_8_ICT(),
      Inffeldgasse25E_8_DataBase.Inffeldgasse25E_8_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25E_8/InternalGains_Inffeldgasse25E_8.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25E_8/AHU_Inffeldgasse25E_8.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25E_8/Tset_Inffeldgasse25E_8.mat"),
    columns=2:8)
