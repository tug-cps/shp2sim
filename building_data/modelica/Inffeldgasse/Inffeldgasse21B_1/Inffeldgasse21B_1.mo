...
within Inffeldgasse.Inffeldgasse21B_1;
model Inffeldgasse21B_1
  "This is the simulation model of Inffeldgasse21B_1 with traceable ID 32"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 8875.0967088528,
    ABuilding=2075.137939453125,
    ASurTot=44783.19744370964,
    numZones = 7,
    zoneParam = {
      Inffeldgasse21B_1_DataBase.Inffeldgasse21B_1_Office(),
      Inffeldgasse21B_1_DataBase.Inffeldgasse21B_1_Floor(),
      Inffeldgasse21B_1_DataBase.Inffeldgasse21B_1_Storage(),
      Inffeldgasse21B_1_DataBase.Inffeldgasse21B_1_Meeting(),
      Inffeldgasse21B_1_DataBase.Inffeldgasse21B_1_Restroom(),
      Inffeldgasse21B_1_DataBase.Inffeldgasse21B_1_ICT(),
      Inffeldgasse21B_1_DataBase.Inffeldgasse21B_1_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse21B_1/InternalGains_Inffeldgasse21B_1.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse21B_1/AHU_Inffeldgasse21B_1.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse21B_1/Tset_Inffeldgasse21B_1.mat"),
    columns=2:8)
