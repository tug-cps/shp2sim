...
within Inffeldgasse.Inffeldgasse25B_1;
model Inffeldgasse25B_1
  "This is the simulation model of Inffeldgasse25B_1 with traceable ID 82"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 3518.1063886396587,
    ABuilding=429.936767578125,
    ASurTot=13426.315846627711,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25B_1_DataBase.Inffeldgasse25B_1_Office(),
      Inffeldgasse25B_1_DataBase.Inffeldgasse25B_1_Floor(),
      Inffeldgasse25B_1_DataBase.Inffeldgasse25B_1_Storage(),
      Inffeldgasse25B_1_DataBase.Inffeldgasse25B_1_Meeting(),
      Inffeldgasse25B_1_DataBase.Inffeldgasse25B_1_Restroom(),
      Inffeldgasse25B_1_DataBase.Inffeldgasse25B_1_ICT(),
      Inffeldgasse25B_1_DataBase.Inffeldgasse25B_1_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25B_1/InternalGains_Inffeldgasse25B_1.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25B_1/AHU_Inffeldgasse25B_1.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25B_1/Tset_Inffeldgasse25B_1.mat"),
    columns=2:8)
