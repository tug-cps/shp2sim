...
within Inffeldgasse.Inffeldgasse25F_9;
model Inffeldgasse25F_9
  "This is the simulation model of Inffeldgasse25F_9 with traceable ID 54"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 417.5462912768125,
    ABuilding=46.158203125,
    ASurTot=2183.5955009301897,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25F_9_DataBase.Inffeldgasse25F_9_Office(),
      Inffeldgasse25F_9_DataBase.Inffeldgasse25F_9_Floor(),
      Inffeldgasse25F_9_DataBase.Inffeldgasse25F_9_Storage(),
      Inffeldgasse25F_9_DataBase.Inffeldgasse25F_9_Meeting(),
      Inffeldgasse25F_9_DataBase.Inffeldgasse25F_9_Restroom(),
      Inffeldgasse25F_9_DataBase.Inffeldgasse25F_9_ICT(),
      Inffeldgasse25F_9_DataBase.Inffeldgasse25F_9_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25F_9/InternalGains_Inffeldgasse25F_9.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25F_9/AHU_Inffeldgasse25F_9.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25F_9/Tset_Inffeldgasse25F_9.mat"),
    columns=2:8)
