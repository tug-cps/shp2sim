...
within Inffeldgasse.Inffeldgasse19_1;
model Inffeldgasse19_1
  "This is the simulation model of Inffeldgasse19_1 with traceable ID 44"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 7356.760685443878,
    ABuilding=1734.0625,
    ASurTot=39128.30463520778,
    numZones = 7,
    zoneParam = {
      Inffeldgasse19_1_DataBase.Inffeldgasse19_1_Office(),
      Inffeldgasse19_1_DataBase.Inffeldgasse19_1_Floor(),
      Inffeldgasse19_1_DataBase.Inffeldgasse19_1_Storage(),
      Inffeldgasse19_1_DataBase.Inffeldgasse19_1_Meeting(),
      Inffeldgasse19_1_DataBase.Inffeldgasse19_1_Restroom(),
      Inffeldgasse19_1_DataBase.Inffeldgasse19_1_ICT(),
      Inffeldgasse19_1_DataBase.Inffeldgasse19_1_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse19_1/InternalGains_Inffeldgasse19_1.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse19_1/AHU_Inffeldgasse19_1.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse19_1/Tset_Inffeldgasse19_1.mat"),
    columns=2:8)
