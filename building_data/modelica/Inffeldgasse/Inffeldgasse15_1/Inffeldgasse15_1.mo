...
within Inffeldgasse.Inffeldgasse15_1;
model Inffeldgasse15_1
  "This is the simulation model of Inffeldgasse15_1 with traceable ID 39"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 861.7799291908741,
    ABuilding=159.00048828125,
    ASurTot=3443.184447211174,
    numZones = 7,
    zoneParam = {
      Inffeldgasse15_1_DataBase.Inffeldgasse15_1_Office(),
      Inffeldgasse15_1_DataBase.Inffeldgasse15_1_Floor(),
      Inffeldgasse15_1_DataBase.Inffeldgasse15_1_Storage(),
      Inffeldgasse15_1_DataBase.Inffeldgasse15_1_Meeting(),
      Inffeldgasse15_1_DataBase.Inffeldgasse15_1_Restroom(),
      Inffeldgasse15_1_DataBase.Inffeldgasse15_1_ICT(),
      Inffeldgasse15_1_DataBase.Inffeldgasse15_1_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse15_1/InternalGains_Inffeldgasse15_1.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse15_1/AHU_Inffeldgasse15_1.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse15_1/Tset_Inffeldgasse15_1.mat"),
    columns=2:8)
