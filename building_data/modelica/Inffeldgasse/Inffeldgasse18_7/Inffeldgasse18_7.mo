...
within Inffeldgasse.Inffeldgasse18_7;
model Inffeldgasse18_7
  "This is the simulation model of Inffeldgasse18_7 with traceable ID 17"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 685.8564682453871,
    ABuilding=205.906494140625,
    ASurTot=4030.5809884808955,
    numZones = 7,
    zoneParam = {
      Inffeldgasse18_7_DataBase.Inffeldgasse18_7_Office(),
      Inffeldgasse18_7_DataBase.Inffeldgasse18_7_Floor(),
      Inffeldgasse18_7_DataBase.Inffeldgasse18_7_Storage(),
      Inffeldgasse18_7_DataBase.Inffeldgasse18_7_Meeting(),
      Inffeldgasse18_7_DataBase.Inffeldgasse18_7_Restroom(),
      Inffeldgasse18_7_DataBase.Inffeldgasse18_7_ICT(),
      Inffeldgasse18_7_DataBase.Inffeldgasse18_7_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse18_7/InternalGains_Inffeldgasse18_7.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse18_7/AHU_Inffeldgasse18_7.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse18_7/Tset_Inffeldgasse18_7.mat"),
    columns=2:8)
