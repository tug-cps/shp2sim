...
within Inffeldgasse.Inffeldgasse25D_1;
model Inffeldgasse25D_1
  "This is the simulation model of Inffeldgasse25D_1 with traceable ID 66"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 4588.170210905374,
    ABuilding=1102.37060546875,
    ASurTot=22015.599926430325,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25D_1_DataBase.Inffeldgasse25D_1_Office(),
      Inffeldgasse25D_1_DataBase.Inffeldgasse25D_1_Floor(),
      Inffeldgasse25D_1_DataBase.Inffeldgasse25D_1_Storage(),
      Inffeldgasse25D_1_DataBase.Inffeldgasse25D_1_Meeting(),
      Inffeldgasse25D_1_DataBase.Inffeldgasse25D_1_Restroom(),
      Inffeldgasse25D_1_DataBase.Inffeldgasse25D_1_ICT(),
      Inffeldgasse25D_1_DataBase.Inffeldgasse25D_1_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25D_1/InternalGains_Inffeldgasse25D_1.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25D_1/AHU_Inffeldgasse25D_1.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25D_1/Tset_Inffeldgasse25D_1.mat"),
    columns=2:8)
