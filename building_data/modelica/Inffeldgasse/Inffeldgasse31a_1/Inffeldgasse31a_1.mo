...
within Inffeldgasse.Inffeldgasse31a_1;
model Inffeldgasse31a_1
  "This is the simulation model of Inffeldgasse31a_1 with traceable ID 21"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 840.3368333727124,
    ABuilding=278.2568359375,
    ASurTot=4654.053072130106,
    numZones = 7,
    zoneParam = {
      Inffeldgasse31a_1_DataBase.Inffeldgasse31a_1_Office(),
      Inffeldgasse31a_1_DataBase.Inffeldgasse31a_1_Floor(),
      Inffeldgasse31a_1_DataBase.Inffeldgasse31a_1_Storage(),
      Inffeldgasse31a_1_DataBase.Inffeldgasse31a_1_Meeting(),
      Inffeldgasse31a_1_DataBase.Inffeldgasse31a_1_Restroom(),
      Inffeldgasse31a_1_DataBase.Inffeldgasse31a_1_ICT(),
      Inffeldgasse31a_1_DataBase.Inffeldgasse31a_1_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse31a_1/InternalGains_Inffeldgasse31a_1.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse31a_1/AHU_Inffeldgasse31a_1.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse31a_1/Tset_Inffeldgasse31a_1.mat"),
    columns=2:8)
