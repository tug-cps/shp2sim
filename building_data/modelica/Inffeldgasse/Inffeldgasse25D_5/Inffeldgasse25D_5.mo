...
within Inffeldgasse.Inffeldgasse25D_5;
model Inffeldgasse25D_5
  "This is the simulation model of Inffeldgasse25D_5 with traceable ID 70"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 6017.583795160055,
    ABuilding=2117.0048828125,
    ASurTot=36880.92376851613,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25D_5_DataBase.Inffeldgasse25D_5_Office(),
      Inffeldgasse25D_5_DataBase.Inffeldgasse25D_5_Floor(),
      Inffeldgasse25D_5_DataBase.Inffeldgasse25D_5_Storage(),
      Inffeldgasse25D_5_DataBase.Inffeldgasse25D_5_Meeting(),
      Inffeldgasse25D_5_DataBase.Inffeldgasse25D_5_Restroom(),
      Inffeldgasse25D_5_DataBase.Inffeldgasse25D_5_ICT(),
      Inffeldgasse25D_5_DataBase.Inffeldgasse25D_5_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25D_5/InternalGains_Inffeldgasse25D_5.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25D_5/AHU_Inffeldgasse25D_5.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25D_5/Tset_Inffeldgasse25D_5.mat"),
    columns=2:8)
