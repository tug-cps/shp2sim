...
within Inffeldgasse.Inffeldgasse12_3;
model Inffeldgasse12_3
  "This is the simulation model of Inffeldgasse12_3 with traceable ID 11"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 1893.132822401822,
    ABuilding=299.53369140625,
    ASurTot=7346.766743991157,
    numZones = 7,
    zoneParam = {
      Inffeldgasse12_3_DataBase.Inffeldgasse12_3_Office(),
      Inffeldgasse12_3_DataBase.Inffeldgasse12_3_Floor(),
      Inffeldgasse12_3_DataBase.Inffeldgasse12_3_Storage(),
      Inffeldgasse12_3_DataBase.Inffeldgasse12_3_Meeting(),
      Inffeldgasse12_3_DataBase.Inffeldgasse12_3_Restroom(),
      Inffeldgasse12_3_DataBase.Inffeldgasse12_3_ICT(),
      Inffeldgasse12_3_DataBase.Inffeldgasse12_3_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse12_3/InternalGains_Inffeldgasse12_3.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse12_3/AHU_Inffeldgasse12_3.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse12_3/Tset_Inffeldgasse12_3.mat"),
    columns=2:8)
