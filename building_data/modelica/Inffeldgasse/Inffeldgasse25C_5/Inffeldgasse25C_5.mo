...
within Inffeldgasse.Inffeldgasse25C_5;
model Inffeldgasse25C_5
  "This is the simulation model of Inffeldgasse25C_5 with traceable ID 78"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 261.06119787693024,
    ABuilding=36.05761718750001,
    ASurTot=1124.008873499314,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25C_5_DataBase.Inffeldgasse25C_5_Office(),
      Inffeldgasse25C_5_DataBase.Inffeldgasse25C_5_Floor(),
      Inffeldgasse25C_5_DataBase.Inffeldgasse25C_5_Storage(),
      Inffeldgasse25C_5_DataBase.Inffeldgasse25C_5_Meeting(),
      Inffeldgasse25C_5_DataBase.Inffeldgasse25C_5_Restroom(),
      Inffeldgasse25C_5_DataBase.Inffeldgasse25C_5_ICT(),
      Inffeldgasse25C_5_DataBase.Inffeldgasse25C_5_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25C_5/InternalGains_Inffeldgasse25C_5.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25C_5/AHU_Inffeldgasse25C_5.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25C_5/Tset_Inffeldgasse25C_5.mat"),
    columns=2:8)
