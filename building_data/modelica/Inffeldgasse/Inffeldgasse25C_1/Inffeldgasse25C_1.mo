...
within Inffeldgasse.Inffeldgasse25C_1;
model Inffeldgasse25C_1
  "This is the simulation model of Inffeldgasse25C_1 with traceable ID 74"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 3046.350464969874,
    ABuilding=447.0996093749999,
    ASurTot=11764.48493278751,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25C_1_DataBase.Inffeldgasse25C_1_Office(),
      Inffeldgasse25C_1_DataBase.Inffeldgasse25C_1_Floor(),
      Inffeldgasse25C_1_DataBase.Inffeldgasse25C_1_Storage(),
      Inffeldgasse25C_1_DataBase.Inffeldgasse25C_1_Meeting(),
      Inffeldgasse25C_1_DataBase.Inffeldgasse25C_1_Restroom(),
      Inffeldgasse25C_1_DataBase.Inffeldgasse25C_1_ICT(),
      Inffeldgasse25C_1_DataBase.Inffeldgasse25C_1_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25C_1/InternalGains_Inffeldgasse25C_1.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25C_1/AHU_Inffeldgasse25C_1.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25C_1/Tset_Inffeldgasse25C_1.mat"),
    columns=2:8)
