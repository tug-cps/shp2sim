...
within Inffeldgasse.Inffeldgasse18_6;
model Inffeldgasse18_6
  "This is the simulation model of Inffeldgasse18_6 with traceable ID 16"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 3323.0863042175765,
    ABuilding=727.20947265625,
    ASurTot=15858.006001146185,
    numZones = 7,
    zoneParam = {
      Inffeldgasse18_6_DataBase.Inffeldgasse18_6_Office(),
      Inffeldgasse18_6_DataBase.Inffeldgasse18_6_Floor(),
      Inffeldgasse18_6_DataBase.Inffeldgasse18_6_Storage(),
      Inffeldgasse18_6_DataBase.Inffeldgasse18_6_Meeting(),
      Inffeldgasse18_6_DataBase.Inffeldgasse18_6_Restroom(),
      Inffeldgasse18_6_DataBase.Inffeldgasse18_6_ICT(),
      Inffeldgasse18_6_DataBase.Inffeldgasse18_6_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse18_6/InternalGains_Inffeldgasse18_6.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse18_6/AHU_Inffeldgasse18_6.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse18_6/Tset_Inffeldgasse18_6.mat"),
    columns=2:8)
