...
within Inffeldgasse.Inffeldgasse25F_2;
model Inffeldgasse25F_2
  "This is the simulation model of Inffeldgasse25F_2 with traceable ID 47"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 6232.187408700585,
    ABuilding=2091.272216796875,
    ASurTot=39939.6543620714,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25F_2_DataBase.Inffeldgasse25F_2_Office(),
      Inffeldgasse25F_2_DataBase.Inffeldgasse25F_2_Floor(),
      Inffeldgasse25F_2_DataBase.Inffeldgasse25F_2_Storage(),
      Inffeldgasse25F_2_DataBase.Inffeldgasse25F_2_Meeting(),
      Inffeldgasse25F_2_DataBase.Inffeldgasse25F_2_Restroom(),
      Inffeldgasse25F_2_DataBase.Inffeldgasse25F_2_ICT(),
      Inffeldgasse25F_2_DataBase.Inffeldgasse25F_2_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25F_2/InternalGains_Inffeldgasse25F_2.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25F_2/AHU_Inffeldgasse25F_2.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25F_2/Tset_Inffeldgasse25F_2.mat"),
    columns=2:8)
