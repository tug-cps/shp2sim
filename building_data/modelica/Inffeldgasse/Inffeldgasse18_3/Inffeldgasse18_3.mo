...
within Inffeldgasse.Inffeldgasse18_3;
model Inffeldgasse18_3
  "This is the simulation model of Inffeldgasse18_3 with traceable ID 14"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 4300.227364361285,
    ABuilding=951.919921875,
    ASurTot=22088.627770463783,
    numZones = 7,
    zoneParam = {
      Inffeldgasse18_3_DataBase.Inffeldgasse18_3_Office(),
      Inffeldgasse18_3_DataBase.Inffeldgasse18_3_Floor(),
      Inffeldgasse18_3_DataBase.Inffeldgasse18_3_Storage(),
      Inffeldgasse18_3_DataBase.Inffeldgasse18_3_Meeting(),
      Inffeldgasse18_3_DataBase.Inffeldgasse18_3_Restroom(),
      Inffeldgasse18_3_DataBase.Inffeldgasse18_3_ICT(),
      Inffeldgasse18_3_DataBase.Inffeldgasse18_3_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse18_3/InternalGains_Inffeldgasse18_3.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse18_3/AHU_Inffeldgasse18_3.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse18_3/Tset_Inffeldgasse18_3.mat"),
    columns=2:8)
