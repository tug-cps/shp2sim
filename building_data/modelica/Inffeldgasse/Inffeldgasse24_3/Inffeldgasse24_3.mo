...
within Inffeldgasse.Inffeldgasse24_3;
model Inffeldgasse24_3
  "This is the simulation model of Inffeldgasse24_3 with traceable ID 3"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 6171.504043523222,
    ABuilding=1935.870849609375,
    ASurTot=35296.46310557551,
    numZones = 7,
    zoneParam = {
      Inffeldgasse24_3_DataBase.Inffeldgasse24_3_Office(),
      Inffeldgasse24_3_DataBase.Inffeldgasse24_3_Floor(),
      Inffeldgasse24_3_DataBase.Inffeldgasse24_3_Storage(),
      Inffeldgasse24_3_DataBase.Inffeldgasse24_3_Meeting(),
      Inffeldgasse24_3_DataBase.Inffeldgasse24_3_Restroom(),
      Inffeldgasse24_3_DataBase.Inffeldgasse24_3_ICT(),
      Inffeldgasse24_3_DataBase.Inffeldgasse24_3_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse24_3/InternalGains_Inffeldgasse24_3.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse24_3/AHU_Inffeldgasse24_3.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse24_3/Tset_Inffeldgasse24_3.mat"),
    columns=2:8)
