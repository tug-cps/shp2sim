...
within Inffeldgasse.Inffeldgasse25C_8;
model Inffeldgasse25C_8
  "This is the simulation model of Inffeldgasse25C_8 with traceable ID 81"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 7034.72403138876,
    ABuilding=1521.1083984375,
    ASurTot=35069.9363753073,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25C_8_DataBase.Inffeldgasse25C_8_Office(),
      Inffeldgasse25C_8_DataBase.Inffeldgasse25C_8_Floor(),
      Inffeldgasse25C_8_DataBase.Inffeldgasse25C_8_Storage(),
      Inffeldgasse25C_8_DataBase.Inffeldgasse25C_8_Meeting(),
      Inffeldgasse25C_8_DataBase.Inffeldgasse25C_8_Restroom(),
      Inffeldgasse25C_8_DataBase.Inffeldgasse25C_8_ICT(),
      Inffeldgasse25C_8_DataBase.Inffeldgasse25C_8_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25C_8/InternalGains_Inffeldgasse25C_8.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25C_8/AHU_Inffeldgasse25C_8.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25C_8/Tset_Inffeldgasse25C_8.mat"),
    columns=2:8)
