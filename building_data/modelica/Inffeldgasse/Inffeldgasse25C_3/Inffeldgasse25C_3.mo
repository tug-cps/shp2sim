...
within Inffeldgasse.Inffeldgasse25C_3;
model Inffeldgasse25C_3
  "This is the simulation model of Inffeldgasse25C_3 with traceable ID 76"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 6333.854049056768,
    ABuilding=2085.767578125,
    ASurTot=40277.2101951631,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25C_3_DataBase.Inffeldgasse25C_3_Office(),
      Inffeldgasse25C_3_DataBase.Inffeldgasse25C_3_Floor(),
      Inffeldgasse25C_3_DataBase.Inffeldgasse25C_3_Storage(),
      Inffeldgasse25C_3_DataBase.Inffeldgasse25C_3_Meeting(),
      Inffeldgasse25C_3_DataBase.Inffeldgasse25C_3_Restroom(),
      Inffeldgasse25C_3_DataBase.Inffeldgasse25C_3_ICT(),
      Inffeldgasse25C_3_DataBase.Inffeldgasse25C_3_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25C_3/InternalGains_Inffeldgasse25C_3.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25C_3/AHU_Inffeldgasse25C_3.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25C_3/Tset_Inffeldgasse25C_3.mat"),
    columns=2:8)
