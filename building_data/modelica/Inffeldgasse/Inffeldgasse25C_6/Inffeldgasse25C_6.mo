...
within Inffeldgasse.Inffeldgasse25C_6;
model Inffeldgasse25C_6
  "This is the simulation model of Inffeldgasse25C_6 with traceable ID 79"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 639.5948384702206,
    ABuilding=92.43701171875,
    ASurTot=2885.1669114817378,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25C_6_DataBase.Inffeldgasse25C_6_Office(),
      Inffeldgasse25C_6_DataBase.Inffeldgasse25C_6_Floor(),
      Inffeldgasse25C_6_DataBase.Inffeldgasse25C_6_Storage(),
      Inffeldgasse25C_6_DataBase.Inffeldgasse25C_6_Meeting(),
      Inffeldgasse25C_6_DataBase.Inffeldgasse25C_6_Restroom(),
      Inffeldgasse25C_6_DataBase.Inffeldgasse25C_6_ICT(),
      Inffeldgasse25C_6_DataBase.Inffeldgasse25C_6_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25C_6/InternalGains_Inffeldgasse25C_6.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25C_6/AHU_Inffeldgasse25C_6.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25C_6/Tset_Inffeldgasse25C_6.mat"),
    columns=2:8)
