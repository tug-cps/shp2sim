...
within Inffeldgasse.Inffeldgasse25F_6;
model Inffeldgasse25F_6
  "This is the simulation model of Inffeldgasse25F_6 with traceable ID 51"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 1063.8140143305063,
    ABuilding=190.66064453125,
    ASurTot=4275.032600831297,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25F_6_DataBase.Inffeldgasse25F_6_Office(),
      Inffeldgasse25F_6_DataBase.Inffeldgasse25F_6_Floor(),
      Inffeldgasse25F_6_DataBase.Inffeldgasse25F_6_Storage(),
      Inffeldgasse25F_6_DataBase.Inffeldgasse25F_6_Meeting(),
      Inffeldgasse25F_6_DataBase.Inffeldgasse25F_6_Restroom(),
      Inffeldgasse25F_6_DataBase.Inffeldgasse25F_6_ICT(),
      Inffeldgasse25F_6_DataBase.Inffeldgasse25F_6_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25F_6/InternalGains_Inffeldgasse25F_6.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25F_6/AHU_Inffeldgasse25F_6.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25F_6/Tset_Inffeldgasse25F_6.mat"),
    columns=2:8)
