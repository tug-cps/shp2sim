...
within Inffeldgasse.Inffeldgasse25A_7;
model Inffeldgasse25A_7
  "This is the simulation model of Inffeldgasse25A_7 with traceable ID 100"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 365.1617431640625,
    ABuilding=48.688232421875,
    ASurTot=1600.0162494004778,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25A_7_DataBase.Inffeldgasse25A_7_Office(),
      Inffeldgasse25A_7_DataBase.Inffeldgasse25A_7_Floor(),
      Inffeldgasse25A_7_DataBase.Inffeldgasse25A_7_Storage(),
      Inffeldgasse25A_7_DataBase.Inffeldgasse25A_7_Meeting(),
      Inffeldgasse25A_7_DataBase.Inffeldgasse25A_7_Restroom(),
      Inffeldgasse25A_7_DataBase.Inffeldgasse25A_7_ICT(),
      Inffeldgasse25A_7_DataBase.Inffeldgasse25A_7_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25A_7/InternalGains_Inffeldgasse25A_7.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25A_7/AHU_Inffeldgasse25A_7.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25A_7/Tset_Inffeldgasse25A_7.mat"),
    columns=2:8)
