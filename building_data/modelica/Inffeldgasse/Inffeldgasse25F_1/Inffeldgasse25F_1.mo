...
within Inffeldgasse.Inffeldgasse25F_1;
model Inffeldgasse25F_1
  "This is the simulation model of Inffeldgasse25F_1 with traceable ID 46"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 2184.287626363337,
    ABuilding=352.71435546875,
    ASurTot=8529.201888534417,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25F_1_DataBase.Inffeldgasse25F_1_Office(),
      Inffeldgasse25F_1_DataBase.Inffeldgasse25F_1_Floor(),
      Inffeldgasse25F_1_DataBase.Inffeldgasse25F_1_Storage(),
      Inffeldgasse25F_1_DataBase.Inffeldgasse25F_1_Meeting(),
      Inffeldgasse25F_1_DataBase.Inffeldgasse25F_1_Restroom(),
      Inffeldgasse25F_1_DataBase.Inffeldgasse25F_1_ICT(),
      Inffeldgasse25F_1_DataBase.Inffeldgasse25F_1_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25F_1/InternalGains_Inffeldgasse25F_1.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25F_1/AHU_Inffeldgasse25F_1.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25F_1/Tset_Inffeldgasse25F_1.mat"),
    columns=2:8)
