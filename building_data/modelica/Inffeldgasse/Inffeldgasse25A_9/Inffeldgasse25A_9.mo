...
within Inffeldgasse.Inffeldgasse25A_9;
model Inffeldgasse25A_9
  "This is the simulation model of Inffeldgasse25A_9 with traceable ID 102"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 314.2365635111928,
    ABuilding=71.321533203125,
    ASurTot=1471.954348410629,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25A_9_DataBase.Inffeldgasse25A_9_Office(),
      Inffeldgasse25A_9_DataBase.Inffeldgasse25A_9_Floor(),
      Inffeldgasse25A_9_DataBase.Inffeldgasse25A_9_Storage(),
      Inffeldgasse25A_9_DataBase.Inffeldgasse25A_9_Meeting(),
      Inffeldgasse25A_9_DataBase.Inffeldgasse25A_9_Restroom(),
      Inffeldgasse25A_9_DataBase.Inffeldgasse25A_9_ICT(),
      Inffeldgasse25A_9_DataBase.Inffeldgasse25A_9_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25A_9/InternalGains_Inffeldgasse25A_9.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25A_9/AHU_Inffeldgasse25A_9.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25A_9/Tset_Inffeldgasse25A_9.mat"),
    columns=2:8)
