...
within Inffeldgasse.Inffeldgasse25B_5;
model Inffeldgasse25B_5
  "This is the simulation model of Inffeldgasse25B_5 with traceable ID 86"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 417.92432130873203,
    ABuilding=67.2060546875,
    ASurTot=1671.2793884939697,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25B_5_DataBase.Inffeldgasse25B_5_Office(),
      Inffeldgasse25B_5_DataBase.Inffeldgasse25B_5_Floor(),
      Inffeldgasse25B_5_DataBase.Inffeldgasse25B_5_Storage(),
      Inffeldgasse25B_5_DataBase.Inffeldgasse25B_5_Meeting(),
      Inffeldgasse25B_5_DataBase.Inffeldgasse25B_5_Restroom(),
      Inffeldgasse25B_5_DataBase.Inffeldgasse25B_5_ICT(),
      Inffeldgasse25B_5_DataBase.Inffeldgasse25B_5_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25B_5/InternalGains_Inffeldgasse25B_5.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25B_5/AHU_Inffeldgasse25B_5.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25B_5/Tset_Inffeldgasse25B_5.mat"),
    columns=2:8)
