...
within Inffeldgasse.Inffeldgasse18_2;
model Inffeldgasse18_2
  "This is the simulation model of Inffeldgasse18_2 with traceable ID 105"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 8274.477297551932,
    ABuilding=2033.62451171875,
    ASurTot=41769.94635540876,
    numZones = 7,
    zoneParam = {
      Inffeldgasse18_2_DataBase.Inffeldgasse18_2_Office(),
      Inffeldgasse18_2_DataBase.Inffeldgasse18_2_Floor(),
      Inffeldgasse18_2_DataBase.Inffeldgasse18_2_Storage(),
      Inffeldgasse18_2_DataBase.Inffeldgasse18_2_Meeting(),
      Inffeldgasse18_2_DataBase.Inffeldgasse18_2_Restroom(),
      Inffeldgasse18_2_DataBase.Inffeldgasse18_2_ICT(),
      Inffeldgasse18_2_DataBase.Inffeldgasse18_2_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse18_2/InternalGains_Inffeldgasse18_2.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse18_2/AHU_Inffeldgasse18_2.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse18_2/Tset_Inffeldgasse18_2.mat"),
    columns=2:8)
