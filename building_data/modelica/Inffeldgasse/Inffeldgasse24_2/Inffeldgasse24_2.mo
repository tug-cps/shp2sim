...
within Inffeldgasse.Inffeldgasse24_2;
model Inffeldgasse24_2
  "This is the simulation model of Inffeldgasse24_2 with traceable ID 2"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 234.19573138654238,
    ABuilding=43.36962890625,
    ASurTot=1013.3675195700711,
    numZones = 7,
    zoneParam = {
      Inffeldgasse24_2_DataBase.Inffeldgasse24_2_Office(),
      Inffeldgasse24_2_DataBase.Inffeldgasse24_2_Floor(),
      Inffeldgasse24_2_DataBase.Inffeldgasse24_2_Storage(),
      Inffeldgasse24_2_DataBase.Inffeldgasse24_2_Meeting(),
      Inffeldgasse24_2_DataBase.Inffeldgasse24_2_Restroom(),
      Inffeldgasse24_2_DataBase.Inffeldgasse24_2_ICT(),
      Inffeldgasse24_2_DataBase.Inffeldgasse24_2_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse24_2/InternalGains_Inffeldgasse24_2.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse24_2/AHU_Inffeldgasse24_2.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse24_2/Tset_Inffeldgasse24_2.mat"),
    columns=2:8)
