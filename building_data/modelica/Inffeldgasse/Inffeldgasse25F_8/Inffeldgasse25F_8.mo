...
within Inffeldgasse.Inffeldgasse25F_8;
model Inffeldgasse25F_8
  "This is the simulation model of Inffeldgasse25F_8 with traceable ID 53"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 59.14224836975337,
    ABuilding=12.135009765624998,
    ASurTot=295.5761649250798,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25F_8_DataBase.Inffeldgasse25F_8_Office(),
      Inffeldgasse25F_8_DataBase.Inffeldgasse25F_8_Floor(),
      Inffeldgasse25F_8_DataBase.Inffeldgasse25F_8_Storage(),
      Inffeldgasse25F_8_DataBase.Inffeldgasse25F_8_Meeting(),
      Inffeldgasse25F_8_DataBase.Inffeldgasse25F_8_Restroom(),
      Inffeldgasse25F_8_DataBase.Inffeldgasse25F_8_ICT(),
      Inffeldgasse25F_8_DataBase.Inffeldgasse25F_8_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25F_8/InternalGains_Inffeldgasse25F_8.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25F_8/AHU_Inffeldgasse25F_8.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25F_8/Tset_Inffeldgasse25F_8.mat"),
    columns=2:8)
