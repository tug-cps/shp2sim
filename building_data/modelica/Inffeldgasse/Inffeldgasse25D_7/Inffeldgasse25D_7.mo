...
within Inffeldgasse.Inffeldgasse25D_7;
model Inffeldgasse25D_7
  "This is the simulation model of Inffeldgasse25D_7 with traceable ID 72"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 3400.494084589184,
    ABuilding=1267.27880859375,
    ASurTot=20673.54878012339,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25D_7_DataBase.Inffeldgasse25D_7_Office(),
      Inffeldgasse25D_7_DataBase.Inffeldgasse25D_7_Floor(),
      Inffeldgasse25D_7_DataBase.Inffeldgasse25D_7_Storage(),
      Inffeldgasse25D_7_DataBase.Inffeldgasse25D_7_Meeting(),
      Inffeldgasse25D_7_DataBase.Inffeldgasse25D_7_Restroom(),
      Inffeldgasse25D_7_DataBase.Inffeldgasse25D_7_ICT(),
      Inffeldgasse25D_7_DataBase.Inffeldgasse25D_7_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25D_7/InternalGains_Inffeldgasse25D_7.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25D_7/AHU_Inffeldgasse25D_7.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25D_7/Tset_Inffeldgasse25D_7.mat"),
    columns=2:8)
