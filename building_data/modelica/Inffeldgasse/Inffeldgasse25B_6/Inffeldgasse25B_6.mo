...
within Inffeldgasse.Inffeldgasse25B_6;
model Inffeldgasse25B_6
  "This is the simulation model of Inffeldgasse25B_6 with traceable ID 87"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 472.869873046875,
    ABuilding=63.04931640624999,
    ASurTot=1960.9536572052878,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25B_6_DataBase.Inffeldgasse25B_6_Office(),
      Inffeldgasse25B_6_DataBase.Inffeldgasse25B_6_Floor(),
      Inffeldgasse25B_6_DataBase.Inffeldgasse25B_6_Storage(),
      Inffeldgasse25B_6_DataBase.Inffeldgasse25B_6_Meeting(),
      Inffeldgasse25B_6_DataBase.Inffeldgasse25B_6_Restroom(),
      Inffeldgasse25B_6_DataBase.Inffeldgasse25B_6_ICT(),
      Inffeldgasse25B_6_DataBase.Inffeldgasse25B_6_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25B_6/InternalGains_Inffeldgasse25B_6.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25B_6/AHU_Inffeldgasse25B_6.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25B_6/Tset_Inffeldgasse25B_6.mat"),
    columns=2:8)
