...
within Inffeldgasse.Inffeldgasse12_2;
model Inffeldgasse12_2
  "This is the simulation model of Inffeldgasse12_2 with traceable ID 10"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 1825.535441070795,
    ABuilding=252.9853515625,
    ASurTot=7041.405092333238,
    numZones = 7,
    zoneParam = {
      Inffeldgasse12_2_DataBase.Inffeldgasse12_2_Office(),
      Inffeldgasse12_2_DataBase.Inffeldgasse12_2_Floor(),
      Inffeldgasse12_2_DataBase.Inffeldgasse12_2_Storage(),
      Inffeldgasse12_2_DataBase.Inffeldgasse12_2_Meeting(),
      Inffeldgasse12_2_DataBase.Inffeldgasse12_2_Restroom(),
      Inffeldgasse12_2_DataBase.Inffeldgasse12_2_ICT(),
      Inffeldgasse12_2_DataBase.Inffeldgasse12_2_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse12_2/InternalGains_Inffeldgasse12_2.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse12_2/AHU_Inffeldgasse12_2.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse12_2/Tset_Inffeldgasse12_2.mat"),
    columns=2:8)
