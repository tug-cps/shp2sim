...
within Inffeldgasse.Inffeldgasse13_1;
model Inffeldgasse13_1
  "This is the simulation model of Inffeldgasse13_1 with traceable ID 40"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 34082.41949599981,
    ABuilding=8860.015625,
    ASurTot=191513.35611261794,
    numZones = 7,
    zoneParam = {
      Inffeldgasse13_1_DataBase.Inffeldgasse13_1_Office(),
      Inffeldgasse13_1_DataBase.Inffeldgasse13_1_Floor(),
      Inffeldgasse13_1_DataBase.Inffeldgasse13_1_Storage(),
      Inffeldgasse13_1_DataBase.Inffeldgasse13_1_Meeting(),
      Inffeldgasse13_1_DataBase.Inffeldgasse13_1_Restroom(),
      Inffeldgasse13_1_DataBase.Inffeldgasse13_1_ICT(),
      Inffeldgasse13_1_DataBase.Inffeldgasse13_1_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse13_1/InternalGains_Inffeldgasse13_1.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse13_1/AHU_Inffeldgasse13_1.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse13_1/Tset_Inffeldgasse13_1.mat"),
    columns=2:8)
