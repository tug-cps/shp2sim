...
within Inffeldgasse.Inffeldgasse16C_1;
model Inffeldgasse16C_1
  "This is the simulation model of Inffeldgasse16C_1 with traceable ID 8"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 14694.848776012663,
    ABuilding=5508.83984375,
    ASurTot=92369.96534910568,
    numZones = 7,
    zoneParam = {
      Inffeldgasse16C_1_DataBase.Inffeldgasse16C_1_Office(),
      Inffeldgasse16C_1_DataBase.Inffeldgasse16C_1_Floor(),
      Inffeldgasse16C_1_DataBase.Inffeldgasse16C_1_Storage(),
      Inffeldgasse16C_1_DataBase.Inffeldgasse16C_1_Meeting(),
      Inffeldgasse16C_1_DataBase.Inffeldgasse16C_1_Restroom(),
      Inffeldgasse16C_1_DataBase.Inffeldgasse16C_1_ICT(),
      Inffeldgasse16C_1_DataBase.Inffeldgasse16C_1_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse16C_1/InternalGains_Inffeldgasse16C_1.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse16C_1/AHU_Inffeldgasse16C_1.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse16C_1/Tset_Inffeldgasse16C_1.mat"),
    columns=2:8)
