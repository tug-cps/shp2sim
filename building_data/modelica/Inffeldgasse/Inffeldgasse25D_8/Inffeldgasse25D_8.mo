...
within Inffeldgasse.Inffeldgasse25D_8;
model Inffeldgasse25D_8
  "This is the simulation model of Inffeldgasse25D_8 with traceable ID 73"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 24.983438551425934,
    ABuilding=9.427734375,
    ASurTot=132.2800698476565,
    numZones = 7,
    zoneParam = {
      Inffeldgasse25D_8_DataBase.Inffeldgasse25D_8_Office(),
      Inffeldgasse25D_8_DataBase.Inffeldgasse25D_8_Floor(),
      Inffeldgasse25D_8_DataBase.Inffeldgasse25D_8_Storage(),
      Inffeldgasse25D_8_DataBase.Inffeldgasse25D_8_Meeting(),
      Inffeldgasse25D_8_DataBase.Inffeldgasse25D_8_Restroom(),
      Inffeldgasse25D_8_DataBase.Inffeldgasse25D_8_ICT(),
      Inffeldgasse25D_8_DataBase.Inffeldgasse25D_8_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25D_8/InternalGains_Inffeldgasse25D_8.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25D_8/AHU_Inffeldgasse25D_8.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse25D_8/Tset_Inffeldgasse25D_8.mat"),
    columns=2:8)
