...
within Inffeldgasse.Inffeldgasse16B_1;
model Inffeldgasse16B_1
  "This is the simulation model of Inffeldgasse16B_1 with traceable ID 5"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 9530.710867390037,
    ABuilding=3576.2607421874995,
    ASurTot=59349.74078978559,
    numZones = 7,
    zoneParam = {
      Inffeldgasse16B_1_DataBase.Inffeldgasse16B_1_Office(),
      Inffeldgasse16B_1_DataBase.Inffeldgasse16B_1_Floor(),
      Inffeldgasse16B_1_DataBase.Inffeldgasse16B_1_Storage(),
      Inffeldgasse16B_1_DataBase.Inffeldgasse16B_1_Meeting(),
      Inffeldgasse16B_1_DataBase.Inffeldgasse16B_1_Restroom(),
      Inffeldgasse16B_1_DataBase.Inffeldgasse16B_1_ICT(),
      Inffeldgasse16B_1_DataBase.Inffeldgasse16B_1_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse16B_1/InternalGains_Inffeldgasse16B_1.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse16B_1/AHU_Inffeldgasse16B_1.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse16B_1/Tset_Inffeldgasse16B_1.mat"),
    columns=2:8)
