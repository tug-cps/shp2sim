...
within Inffeldgasse.Inffeldgasse31_1;
model Inffeldgasse31_1
  "This is the simulation model of Inffeldgasse31_1 with traceable ID 107"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 1610.6899024620654,
    ABuilding=427.80615234375,
    ASurTot=8192.239742862885,
    numZones = 7,
    zoneParam = {
      Inffeldgasse31_1_DataBase.Inffeldgasse31_1_Office(),
      Inffeldgasse31_1_DataBase.Inffeldgasse31_1_Floor(),
      Inffeldgasse31_1_DataBase.Inffeldgasse31_1_Storage(),
      Inffeldgasse31_1_DataBase.Inffeldgasse31_1_Meeting(),
      Inffeldgasse31_1_DataBase.Inffeldgasse31_1_Restroom(),
      Inffeldgasse31_1_DataBase.Inffeldgasse31_1_ICT(),
      Inffeldgasse31_1_DataBase.Inffeldgasse31_1_Laboratory()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse31_1/InternalGains_Inffeldgasse31_1.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse31_1/AHU_Inffeldgasse31_1.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Inffeldgasse/Inffeldgasse31_1/Tset_Inffeldgasse31_1.mat"),
    columns=2:8)
